...
public class NewsChannelAdapter extends BaseMultiItemQuickAdapter<Channel, BaseViewHolder> {
    ...
    public NewsChannelAdapter(List<Channel> data, ItemTouchHelper helper) {
        super(data);
        mIsEdit = false;
